...
function BuscaCEP() {
  ...
  const buscaEndereco = async (cep, goToHistory) => {
    try {
      ...
      setRua(data.logradouro || "Não disponível");
      setBairro(data.bairro || "Não disponível");
      setCidade(data.localidade || "Não disponível");
      setEstado(data.uf || "Não disponível");
  ...
  return (
    <div className="main">
      <div className="header">
        ...
        <div
          className="nav"
          onClick={() => (window.location.href = "busca_cep.html")}
        >
      ...
      <div className="search">
        ...
        />
        <button onClick={() => buscaEndereco(cep, true)}>
